...
export default function MockupDataChart({
    stationId = 'demo',
    height = 450,
    className = '',
}) {
    ...
    const [selectedParams, setSelectedParams] = useState(['pm25', 'pm10', 'temp', 'rh'])
    ...
    useEffect(() => {
        ...
        const series = selectedParams.map(param => {
            ...
            const seriesData = data.data.map(d => [d.datetime, d[param]])
